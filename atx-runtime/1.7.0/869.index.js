...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 360).then(__webpack_require__.t.bind(__webpack_require__, 52979, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
