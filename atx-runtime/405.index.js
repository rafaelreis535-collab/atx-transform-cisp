...
const ruleset_1 = __webpack_require__(58579);
...
var middlewareHostHeader = __webpack_require__(61699);
var middlewareLogger = __webpack_require__(9293);
var middlewareRecursionDetection = __webpack_require__(17121);
var middlewareUserAgent = __webpack_require__(57332);
...
var httpAuthSchemeProvider = __webpack_require__(756);
var runtimeConfig = __webpack_require__(14829);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(15811));
const core_1 = __webpack_require__(48661);
...
const runtimeConfig_shared_1 = __webpack_require__(90082);
...
const httpAuthSchemeProvider_1 = __webpack_require__(756);
const endpointResolver_1 = __webpack_require__(58986);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(15461);
var tokenProviders = __webpack_require__(38290);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(25044); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(59099);
...
var client = __webpack_require__(15461);
var httpAuthSchemes = __webpack_require__(63016);
var propertyProvider = __webpack_require__(71238);
var sharedIniFileLoader = __webpack_require__(94964);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 534).then(__webpack_require__.t.bind(__webpack_require__, 53534, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 534).then(__webpack_require__.t.bind(__webpack_require__, 53534, 19));
